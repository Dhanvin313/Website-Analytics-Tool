...
// Connect to MongoDB
mongoose.connect('mongodb+srv://dhanvin:dhanvin12345@logindb.soeze.mongodb.net/', {
...
app.use(session({
    ...
    store: MongoStore.create({ mongoUrl: 'mongodb+srv://dhanvin:dhanvin12345@logindb.soeze.mongodb.net/' }),  // Store sessions in MongoDB
